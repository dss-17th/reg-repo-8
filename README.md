...
- 가장 크게 영향을 미칠것이라 예상했던 개인 수상 커리어(받은 트로피 수) 또한 몸값에 큰 영향을 미치지 않음.
...
### 미드필더
<img width="1074" alt="스크린샷 2021-06-15 오후 5 41 12" src="https://user-images.githubusercontent.com/53620138/122022004-29697b80-ce01-11eb-8548-34ae5cfed428.png">

### 수비수
<img width="1005" alt="스크린샷 2021-06-15 오후 6 03 59" src="https://user-images.githubusercontent.com/53620138/122025141-12785880-ce04-11eb-88c0-0f6eb49d5421.png">

```
양의 상관관계를 나타낸 컬럼
- 공격수 : 경기당 슈팅횟수, 득점횟수, 팀의 성적
- 미드필더 : 경기당 패스횟수, 팀의성적, 출전횟수, 득점, 수상경력
- 수비수 : 팀의 성적, 출전경기수, 평점, 평균패스 횟수, 수상경력
